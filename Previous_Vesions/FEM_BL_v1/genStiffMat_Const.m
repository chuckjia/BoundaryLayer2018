function [rowIndexVec, colIndexVec, nonZeroElemVec] = genStiffMat_Const(xRange, yRange, meshSize)
...
numNonZeroElemStiffMat = numNonZeroElemStiffMat + 2 * (numGridsX + numGridsY);  % Add boundary layer elements
