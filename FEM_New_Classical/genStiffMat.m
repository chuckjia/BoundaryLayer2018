...
Lx = xRange(2) - xRange(1);  Ly = yRange(2) - yRange(1);
Dx = Lx / numCellsX;  Dy = Ly / numCellsY;  DxDy = Dx * Dy;
cellArea = 0.5 * DxDy;
xGrad = numCellsX / Lx;  yGrad = numCellsY / Ly;
