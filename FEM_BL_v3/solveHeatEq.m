...
% FEM matrices
tic
stiffMat = genStiffMat(xRange, yRange, meshSize, Dt, epsilon, sigma);
...
for stepNo = 1:numTimeStep
    ...
    % FEM
    RHS_FEM = genRHS_FEM(xRange, yRange, meshSize, Dt, epsilon, sigma, f_vec, soln);  % Perform numerical integration
    soln = stiffMat \ RHS_FEM;
    soln = convSolnToRegMesh(soln, xRange, yRange, meshSize, epsilon, sigma);
