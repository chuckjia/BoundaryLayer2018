function solnReg = convSolnToRegMesh(soln, xRange, yRange, meshSize, epsilon, sigma)
...
theta1_vec = phiLinFcn(innerGridX, epsilon, sigma);
solnReg = solnReg + solnTheta1 * theta1_vec;

% theta_2
innerGridY = (yBott + Dy):Dy:(yTop - Dy);
theta2_vec = phiLinFcn(innerGridY, epsilon, sigma);
